													...
													<div class="row">
														<div class="portlet box green">
															<div class="portlet-title">
																<div class="caption">
																    <?php if($role !="3") { ?>
																	<i class="fa fa-gift"></i>Create New Ticket</div>
																	<?php } else {?> <i class="fa fa-gift"></i>View Assigned Tickets</div><?php } ?>
																<div class="tools">
															...
															<div class="portlet-body">
																				...
																				<div class="col-md-12">
																					...
																					<div class="portlet light bordered">
																						<div class="portlet-title">
																							...
																							<?php if($role !="3") { ?>	<span class="caption-subject"> Create / Edit Tickets </span><?php } else {?>
																								<span class="caption-subject"> Use the below form to edit tickets. </span><?php } ?>
																							</div>
																							<div class="actions">
																							</div>
																						</div>
																								...
																								<div class="row">
																									<div class="col-md-6">
																										...
																										<div class="btn-group">
																											...
																											<button data-target="#create_new_ticket" data-toggle="modal" class="btn sbold green create_new_ticket">Create New Ticket
																...
																?>
                                                                                                        ...
                                                                                                        <div class="col-md-4"><br>
                                                                                                            <button id="search_result" class="btn green">Search Records</button>
                                                                                    			...
                                                                                    			<!--<td><?php echo $req_date; ?></td>-->
                                                                                    			 <td ><?php echo $name = $ticket_details[$i]['name']; ?></td> 
                                                                                    				<td ><?php echo $company_name = $ticket_details[$i]['company_name']; ?></td> 
                                                                                    				 ...
                                                                                    				 <td ><?php echo $ticket_details[$i]['updated_by']; ?></td>
                                                                                    				...
                                                                                    				<?php if( $ticket_status != '3'){ ?>
                                                                                    				  <a href="#" data-target="#edit_ticket_details" data-toggle="modal" class="edit_ticket_details btn btn-sm btn-outline grey-salsa" data-id ='<?php echo $ticket_details[$i]['ticket_id']; ?>' title="edit"><i class="fa fa-edit"></i></a></td>
...
<?php include('footer.php'); ?>
       ...
       <!-- Modals starts here!--> 
		    ...
		    <div id="create_new_ticket" class="modal fade"  data-backdrop="static" data-keyboard="false" data-width="1000">
				<div class="modal-body">
					<div class="portlet box" style="background-color: #168d90 !important;">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-gift"></i>Create Ticket Here</div>
                                        <div class="tools">
                                    ...
                                    <div class="portlet-body form" style="background-color: #e0f8ff !important;">
                                         <!-- BEGIN FORM-->
                                       <form action="create_ticket" method="post" id="form_img" enctype="multipart/form-data" accept-charset="utf-8">
                                            <div class="form-body">
												<div class="row">
												<?php 
												...
												$result = $this->User1_model->user_info($user_id);
			                                          if (count($result) > 0){ 
														...
														$company =  $result[0]['company'];
															...
															<!--hidden element-->
															<input type="text" class="form-control hide" name="customer_id" id="form_control_1" placeholder="Enter name" value="<?php echo $user_id; ?>">
															<input type="text" class="form-control hide" name="name" value="<?php echo $username; ?>">
															<input type="text" class="form-control hide" name="contact_number" value="<?php echo $contact_number; ?>">
															...
															<div class="col-md-6">
														  <div class="form-group form-md-line-input">
                                                            <input type="text" class="form-control" name="name" id="form_control_1" placeholder="Enter Name" value="<?php echo $username; ?>" disabled>
														   ...
														   <div class="form-group form-md-line-input has-success">
                                                            <input type="number" class="form-control" name="contact_number" onchange="contact_validate()" minlength="8" id="form_control_1" placeholder="+651234567,12345678,1234567890" value="<?php echo $contact_number; ?>" disabled>
														 ...
														 <div class="form-group form-md-line-input">
															<div class="input-group">
																<input type="text" class="form-control" name="email" id="" placeholder="Enter your email" value="<?php echo $email; ?>" disabled>
													...
													<div class="col-md-6">
													    <div class="col-md-12">
														  ...
														  <div class="col-md-12">
                                                             <div class="form-group form-md-line-input">
                                                                <input class="form-control" name="system" rows="1" placeholder="Device/System"/>
														 ...
														 <div class="form-group form-md-line-input">
														  ...
														  <div class="col-md-12">
														   ...
														   <div class="col-md-12">
                                                             <div class="form-group form-md-line-input">
                                                                <textarea class="form-control" name="issue_desc" rows="1" placeholder="Issue Description"></textarea>
													...
													<div class="col-md-6">
														  <div class="form-group form-md-line-input">
                                                            <input type="text" class="form-control" name="name" id="form_control_1" placeholder="Enter Name">
															<input type="text" class="form-control hide" name="customer_id" id="form_control_1" placeholder="Enter name">
															<label for="form_control_1">Name
																<span class="required">*</span>
															</label>
															<span class="help-block">Enter Name...</span>
														   ...
														   <div class="form-group form-md-line-input has-success">
                                                            <input type="text" class="form-control" name="contact_number" maxlength="10" id="form_control_1" placeholder="Enter Contact Number">
                                                            <label for="form_control_1">Contact Number
                                                                <span class="required">*</span>
                                                            </label>
														   ...
														   <div class="form-group form-md-line-input">
															<input type="text" class="form-control" name="company_name" id="form_control_1" placeholder="Enter Company Name" >
															<label for="form_control_1">Company Name
															</label>
															<span class="help-block">Enter Company Name...</span>
														  </div>
													...
													<div class="col-md-6">
													     <div class="col-md-12">
                                                             <div class="form-group form-md-line-input">
																<input type="text" class="form-control" name="device_location" placeholder="Enter your device location">
																<label for="form_control_1">Device Location
																  <span class="required">*</span></label>
																<span class="help-block">Enter Device Location Here...</span>
														 </div>
											...
											<div class="form-actions" style="background-color: #e0f8ff !important;">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        <button type="submit" id="new_ticket" class="btn green">Create ticket</button>
        ...
        <!-- Pending edit tickets -->
                 <div id="edit_ticket_details" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false" data-width="1000">
                        <div class="modal-body">
                            <div class="portlet box purple">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-gift"></i>Edit Ticket Here</div>
                                                <div class="tools">
                                                    <a href="" class="collapse"> </a>
                                            ...
                                            <div class="portlet-body form">
                                                 <!-- BEGIN FORM-->
                                         <form action="#" id="edit_ticket_form" style="background-color: #e0f8ff !important;" enctype="multipart/form-data" accept-charset="utf-8"> 
                                            <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-2">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                      <label for=""><h4><strong>View Comments:</strong></h4></label>
                                                      <div id="comments"> 
                                                    </div>
                                                    </div>
                                                     </div>
                                            ...
                                            <div class="row">
                                                <input type="hidden" name="update_id" />
                                                  <div class="col-md-6">
														 <div class="form-group form-md-line-input">
															<select class="form-control" name="service_engineer" tabindex="6" <?php if($role == 3 || $role == 4){ echo "disabled"; } ?>>
																<option value="">Select</option>
																<?php $users = $this->db->query("select * from users where role='3'")->result_array();
																	foreach($users as $user){
																	?>
                                                        ...
                                                        <div class="col-md-6">
														 <div class="form-group form-md-line-input">
															...
															<div class="col-md-6">
															<div class="form-group form-md-line-input">
															<textarea id="comment-field" name="description" cols="10" rows="1" class="form-control" spellcheck="false"></textarea>
                                            ...
                                            <div class="form-actions" style="background-color: #e0f8ff !important;">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        <button type="submit" id="pending_edit_ticket_update" class="btn green">Update Ticket</button>
                                                        <button type="reset" class="btn default">Reset</button>
                                                        <button type="button" data-dismiss="modal" class="button_closed btn btn-outline dark">Close</button>
                                                    </div>
                                                </div>
                                            </div>
                                               </div>
