...
<html lang="en">
	<head>
        ...
        <link rel="stylesheet" href="<?php echo base_url()?>assets/pages/scripts/jqwidgets/styles/jqx.base.css" type="text/css" />
        ...
        <style type="text/css">
            ...
            .se-pre-con {
                ...
                height: 100%;
                z-index: 9999;
                background: url(<?php echo base_url()?>assets/pages/img/images/loader-64x/Preloader_2.gif) center no-repeat #fff;
                }  
